            ...
            <div className={"container"} style={{'marginTop': '70px'}}>
                ...
                <div className={"col-12 titulo-span py-2"}>
                    <div className={"align-self-center"}>
                        ...
                        <small><i>(In thousands) 1000 = 1 million</i></small>
                        <iframe
                ...
                <div className={"col-12 titulo-span py-2"}>
                    <div className={"align-self-center"}>
                        <small><i>(In thousands) 1000 = 1 million</i></small>
                        <iframe
                            src='https://tradingeconomics.com/embed/?s=ijcusa&v=202008172100v20200716&h=300&w=600&ref=/united-states/jobless-claims'
                            height='300' width='600' frameBorder='0' scrolling='no'/>
                    </div>
                </div>
